...
const MerchShop = () => {
  ...
  const handleOnClickDeleteMerch = async (e) => {
    try {
      setBusy(true);
      await MerchApi.deleteMerch(e);
      await fetchData();
      setRemove(true);
      setBusy(false);
      setFlag(true);
  ...
  const handleSubmitCreateMerch = async (e) => {
    e.preventDefault();
    ...
    if (
      ...
      try {
        setBusy(true);
        await MerchApi.createMerch(data);
        await fetchData();
        setSuccess(true);
        setBusy(false);
        setMerchName("");
  ...
  const handleSubmitUpdateMerch = async (e) => {
    e.preventDefault();
    ...
    if (
      ...
      try {
        setBusy(true);
        await MerchApi.updateMerch(data);
        await fetchData();
        setUpdate(true);
        setBusy(false);
        setMerchName("");
          ...
          <div className="container">
            <div className="product-management-wrapper">
                  ...
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <button
                            onClick={handleOnClickCreateMerch}
                            className="theme-btn__black"
                          >
                            +
                          </button>
              ...
              >
                ...
                <form
                  onSubmit={
                    flag ? handleSubmitCreateMerch : handleSubmitUpdateMerch
                  }
                    ...
                    <div className="form-group">
                      ...
                      <label>
                        <input
                          ...
                          value={"ADJUSTABLE"}
                          onChange={handleOnChangeSize}
                          checked={size.includes("ADJUSTABLE")}
                        />
                    ...
                    <div className="form-group">
                      ...
                      <label>
                        <input
                          ...
                          value={"Many In Stock"}
                          checked={
                            availability === "Many In Stock" ? true : false
                          }
                        />
                      ...
                      <label>
                        <input
                          ...
                          onChange={handleOnChange}
                          checked={
                            availability === "Little In Stock" ? true : false
                          }
                        />
                      ...
                      <label>
                        <input
                          ...
                          onChange={handleOnChange}
                          checked={
                            availability === "Out Of Stock" ? true : false
                          }
                        />
                    ...
                    <div className="form-group">
                      ...
                      <label>
                        <input
                          type="checkbox"
                          value={"Black Trucker"}
                          checked={color.includes("Black Trucker")}
                          onChange={handleOnChangeColor}
                        />
                  ...
                  <div className="image">
                    ...
                    <label>
                      <input
                        type="file"
                        multiple
                        onChange={(e) => previewImages(e, setMerchImages)}
                        name="productImage"
                        style={{ display: "none" }}
                        accept="image/*"
                      />
                      <span>Choose product images </span>
                      <ShowImages data={merchImages} setData={setMerchImages} />
                    </label>
                  </div>
