...
const ProductManagement = () => {
  ...
  const handleOnClickDeleteProduct = async (e) => {
    try {
      setBusy(true);
          ...
          {busy || !fetchProducts ? (
            ...
            <div className="container">
              <div className="product-management-wrapper">
                ...
                <div
                  className={flag ? "create-product" : "update-product"}
                  ref={productRef}
                >
                  <h3 className="product-title">
                    {flag ? "Create New Product" : "Update Product"}
                  </h3>
                  <form
                    onSubmit={
                      flag
                  ...
                  >
                      ...
                      <div className="form-group">
                        ...
                        <label>
                          <input
                            type="checkbox"
                            value={12}
                            onChange={handleOnChangeBagSize}
                            checked={bagSize.includes(12)}
                          />
                          <span>12 OZ</span>
                        </label>
                        <label>
                      ...
                      <div className="form-group">
                        ...
                        <label>
                          <input
                            type="checkbox"
                            value="whole bean"
                            onChange={handleOnChangeGrind}
                            checked={grind.includes("whole bean")}
                          />
                    ...
                    <div className="image">
                      <label>
                        <input
                          type="file"
                          onChange={(e) => previewImage(e, setImageDisplay)}
                          name="productDisplayImage"
                          style={{ display: "none" }}
                          accept="image/*"
                        />
                        <span>Choose Product Display Image</span>
                      ...
                      <label>
                        <input
                          type="file"
                          multiple
                          onChange={(e) => previewImages(e, setProductImages)}
                          name="productImage"
                          style={{ display: "none" }}
                          accept="image/*"
                        />
                      ...
                      <label>
                        ...
                        <input
                          ...
                          style={{ display: "none" }}
                          accept="image/*"
                          onChange={(e) => previewImage(e, setImgBackground)}
                        />
                        <ShowImage
                          data={imgBackground}
                    ...
                    <div className="making">
                      ...
                      <label>
                        ...
                        <input
                          ...
                          style={{ display: "none" }}
                          accept="image/*"
                          onChange={(e) => previewImage(e, setImgProfile)}
                        />
                        <ShowImage data={imgProfile} setData={setImgProfile} />
                      </label>
                      <label>
                      ...
                      <label>
                        ...
                        <input
                          ...
                          style={{ display: "none" }}
                          accept="image/*"
                          onChange={(e) => previewImage(e, setImgOrigin)}
                        />
                        <ShowImage data={imgOrigin} setData={setImgOrigin} />
                      </label>
                      <label>
                      ...
                      <label>
                        ...
                        <input
                          ...
                          style={{ display: "none" }}
                          accept="image/*"
                          onChange={(e) => previewImage(e, setImgRoast)}
                        />
                        <ShowImage data={imgRoast} setData={setImgRoast} />
                      </label>
                    </div>
                    ...
                    <div className="image-extra">
                      <label>
                        ...
                        <input
                          ...
                          style={{ display: "none" }}
                          accept="image/*"
                          onChange={(e) => previewImage(e, setImgBag)}
                        />
                        <ShowImage data={imgBag} setData={setImgBag} />
                      </label>
                      <label>
                        <span>Choose Subscription Image</span>
                        <input
                          type="file"
                          style={{ display: "none" }}
                          accept="image/*"
                          onChange={(e) => previewImage(e, setImgSub)}
                        />
                        <ShowImage data={imgSub} setData={setImgSub} />
                      </label>
                    </div>
                    <div className="color">
                      <label>
                      ...
                      <label>
                        <span>Choose Subscription Color</span>
                        <input
                          type="color"
                          onChange={handleOnChange}
                    ...
                    <label>
                      <span>Enter Product Discription 1: </span>
                      <textarea
                        rows="10"
                        onChange={handleOnChange}
                        name="productDisc1"
                    ...
                    <label>
                      <span>Enter Product Discription 2: </span>
                      <textarea
                        rows="10"
                        onChange={handleOnChange}
                        name="productDisc2"
                    ...
                    <label>
                      <input
                        type="file"
                        onChange={(e) => previewImage(e, setImgMiddleRoast)}
                        name="ImageMiddleRoast"
                        style={{ display: "none" }}
                        accept="image/*"
                      />
                      <span>Choose Image Middle Roast</span>
                      <div className="show-img">
                        <ShowImage
                          data={imgMiddleRoast}
                    ...
                    <div className="roast">
                      <label>
                        <span>Choose Color Border Roast</span>
                        <input
                          type="color"
                      ...
                      <label>
                        <span>Choose Color Background Roast</span>
                        <input
                          type="color"
