          ...
          >
            ...
            <SwiperSlide className="set-slide">
              <div className="container">
                <div className="slide-content">
                  <h2 className="slide-title">
                    A Yawn Is A Silent Scream For Coffee. Never Run Out!
                  </h2>
                  <p className="slide-desc">
                    Join Our Coffee Club for Special Discounts!
                  </p>
                  <Link
            ...
            <SwiperSlide className="set-slide">
              <div className="container">
                <div className="slide-content">
                  ...
                  <p className="slide-desc">
                    Calculate your consumption needs before you order!
                  </p>
            ...
            <SwiperSlide className="set-slide">
              <div className="container">
                <div className="slide-content">
                  <h2 className="slide-title">Expresso Yourself</h2>
                  <p className="slide-desc">
                    Drink great coffee, look good while doing it!
                  </p>
                  <Link
          ...
          <div className="container">
            <div className="journey-wrapper">
              ...
              <div className="title-wrapper journey-content">
                ...
                <p className=" desc">
                  Choosing exceptional coffee, shouldn’t be a struggle. We
                  wanted to simplify this process, by creating premium roasts
                  that inspire your mornings, accelerate your days, and relax
                  your evenings
                </p>
            ...
            <div className="club-wrapper">
              ...
              <div className="club-box">
                ...
                <div className="club-box__item">
                  ...
                  <p>3. Free shipping, delivered to your door!</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="know-wrapper">
              <div className="title-wrapper">
                ...
                <p className="desc">
                  ...
                  <br />
                  <b>Try our coffee calculator</b>, and learn how much coffee
                  you'll need to stock up!
                </p>
              </div>
              <div className="coffee-calc">
                <form acceptCharset="UTF-8" onSubmit={handleOnSubmitCalc}>
                  <input type="hidden" name="utf8" value={"✓"} />
                  <div className="coffee-cup__size">
                    <h4>Select cup size</h4>
                    <label
                      className={
                        cupSize === "0.36" ? "radio-img radio-bg" : "radio-img"
                      }
                    >
                      <input
                        type="radio"
                    ...
                    <label
                      className={
                        cupSize === "0.48" ? "radio-img radio-bg" : "radio-img"
                      }
                    >
                      <input
                        type="radio"
                    ...
                    <label
                      className={
                        cupSize === "0.6" ? "radio-img radio-bg" : "radio-img"
                      }
                    >
                      <input
                        type="radio"
                    ...
                    <label
                      className={
                        cupSize === "0.72" ? "radio-img radio-bg" : "radio-img"
                      }
                    >
                      <input
                        type="radio"
                  ...
                  <div className="coffee-numberOfCup">
                    <h4>Enter number of cup coffee, you drink per day.</h4>
                  ...
                  <button type="submit" className="theme-btn__black">
                    calculate
                  </button>
                </form>
              </div>
                ...
                {valid && (
                  <>
                    <div className="suggest">
                      Your consumption is
                      <b>
                        <span className="cups"> {data.numberOfCup} </span>
                        cups
                        <span className="oz"> {data.sizeOfCoffee} </span>
                        oz
                      </b>
                      .
                    </div>
                    <div className="suggest">
                      ...
                      <b>
                        <span className="suggest-content">
                          <br />
                          <span className="bags"> {data.bags} </span>
                          Bag(s)
                    ...
                    <div className="suggest">
                      Based on
                      <span className="baseFrequency"> {data.frequency} </span>
                      Days
                    </div>
                  </>
                )}
                {error1 && <div className="errorMsg">{error1}</div>}
                {error2 && <div className="errorMsg">{error2}</div>}
                {error3 && <div className="errorMsg">{error3}</div>}
              </div>
              <div className="blow">
                <div className="title-wrapper">
                  <div className="desc">
              ...
              <div className="quality-flip">
                <div className="flip-inner">
                  <div className="quality-box">
                    <div className="quality-box__item">
                      <img src={handCrafted} alt="hand-crafted" />
                      <p>Hand Crafted</p>
                    </div>
                    <div className="box-content">
                      <div className="box-inner">
                        <h4 className="subtitle">Hand Crafted</h4>
                        <p className="desc">
                          Artisan care, less mass production. Craft coffee is
                          the craftsmanship behind each cup. Artisans who take
                          special care through each step of the creative
                          process, from bean selection at the point of origin,
                          to roasting methods. OKBF coffee is Small Batch
                          Artisan Roasted.
                        </p>
                      </div>
                    </div>
                ...
                <div className="flip-inner">
                  ...
                  <div className="quality-box">
                    ...
                    <div className="box-content">
                      <div className="box-inner">
                        <h4 className="subtitle">Exotic Farm Location</h4>
                        <p className="desc">
                          Think of coffee beans the way people think of wine
                          grapes. Just like wine, coffee tastes different
                          depending on where it is grown, the vineyard or coffee
                          farm it’s from, and the season. Just like wine, coffee
                          comes from a living plant that can expire, so choosing
                          carefully selected beans makes sense. OKBF coffee is
                          responsibly sourced from exotic farm locations.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flip-inner">
                  <div className="quality-box">
                    <div className="quality-box__item">
                      <img src={qualityCup} alt="quality-cup" />
                      <p>Specialty Grade Coffee</p>
                    </div>
                    <div className="box-content">
                      <div className="box-inner">
                        <h4 className="subtitle">Specialty Grade Coffee</h4>
                        <p className="desc">
                          Specialty (premium, gourmet) coffee is a coffee or
                          coffee experience recognized for its distinctive
                          attributes, and because of these attributes, has
                          significant extra value in the marketplace. It is a
                          dedication to quality and care. OKBF is a specialty
                          graded coffee
                        </p>
                      </div>
                    </div>
          ...
          <div className="container">
            <div className="blog-wrapper">
              ...
              <div className="blog-content">
                ...
                <Link to="/blogs/coffee-101" className="theme-btn__black">
                  Learn More
                </Link>
              </div>
            </div>
          ...
          <div className="container">
            <div className="join-wrapper">
              <div className="subtitle title-wrapper">
                <h2 className="title">GET THE SCOOP! JOIN OUR MAILING LIST</h2>
              </div>
