          ...
          <div className="container">
            ...
            <div className="policies-card">
              <ul className="nav-tabs">
                <li
                  className={navActive[0] ? "tab active" : "tab"}
                  value={0}
                ...
                <li
                  className={navActive[1] ? "tab active" : "tab"}
                  value={1}
                  onClick={handleOnClickActive}
                >
                  Returns
                ...
                <li
                  value={2}
                  className={navActive[2] ? "tab active" : "tab"}
                  onClick={handleOnClickActive}
                >
                  Orders
                </li>
                <li
                  className={navActive[3] ? "tab active" : "tab"}
                  value={3}
                  onClick={handleOnClickActive}
                >
                  Privacy
                ...
                <li
                  className={navActive[4] ? "tab active" : "tab"}
                  value={4}
                  onClick={handleOnClickActive}
                >
                  Terms
              ...
              <div className="tab-content">
                <div
                  className={navActive[0] ? "tab-panes active" : "tab-panes"}
                >
                  <h2>
                  ...
                  <p>
                    All orders will be processed and shipped within 24-48 hours
                    after checkout. Orders placed over the weekend or over a
                    holiday, will ship the following business day. (Please note,
                  ...
                  <p>
                    All orders over $40 will ship free, with one of our standard
                    shipping options. (e.g., USPS First Class or USPS Priority
                    for orders over 16 ounces). In some cases, we will ship via
                    another carrier, such as UPS or FedEx depending on the
                    lowest rate available.
                  </p>
                  <h3>
                    <em>
                      <strong>Expedited Shipping Options</strong>
                    </em>
                  </h3>
                  <p>
                    There will be multiple options for expedited shipping
                    available at checkout. We ship USPS, UPS, and FedEx. Please
                    note, all expedited shipping rates will incur an additional
                    shipping cost, and are based on destination, order weight
                    and shipping service chosen. (Please note, as we’re located
                    in the Eastern Time Zone, all expedited orders placed after
                    2pm, will ship the next business day.)
                  </p>
                  <h3>
                    <strong>
                      <i>COVID</i>
                  ...
                  <p>
                    Currently, all national carriers are experiencing delays
                    associated with the ongoing impacts of COVID-19. We
                    apologize in advance and ask for your patience as we
                    navigate these impacts to supply chain.
                  </p>
                  <h3>
                    <strong>
                      <em>Holiday Shipping/Severe Weather</em>
                    </strong>
                  </h3>
                  <p>
                    Please expect longer shipping times and possible delays,
                    during peak seasonal shipping months or in cases of severe
                    weather. As always, our team will work diligently to ship
                    all orders as soon as possible.
                  </p>
                  <p>
                    Still have questions about your order, please email us at
                    hello@okbutfirst.com so we can review and help resolve any
                    shipping issues with your order.
                  </p>
                </div>
                <div
                  className={navActive[1] ? "tab-panes active" : "tab-panes"}
                ></div>
                <div
                  className={navActive[2] ? "tab-panes active" : "tab-panes"}
                ></div>
                <div
                  className={navActive[3] ? "tab-panes active" : "tab-panes"}
                >
                  <meta charSet="UTF-8" />
                  <p>
                    This Privacy Policy describes how okbutfirst.com (the “Site”
                  ...
                  <p>
                    ...
                    collect additional information if you contact us for
                  ...
                  <ul>
                    <li>
                      ...
                      information, what sites or products you view, search
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Purpose of collection:</strong> to provide
                      products or services to you to fulfill our contract, to
                      process your payment information, arrange for shipping,
                      and provide you with invoices and/or order confirmations,
                      communicate with you, screen our orders for potential risk
                      or fraud, and when in line with the preferences you have
                    ...
                    <li>
                      <strong>Disclosure for a business purpose:</strong> shared
                      with our processor Shopify, and fulfillment app
                      ShipStation.
                    </li>
                  </ul>
                  <p>
                  ...
                  <ul>
                    ...
                    <li>
                      We use Automizely App for promotion marketing&nbsp;You can
                      read more about how Automizely&nbsp;uses your Personal
                      Information here:
                      <i>
                        <span data-sanitized-data-mce-fragment="1"> </span>
                      </i>
                      <a
                        target="_blank"
                        rel="noopener noreferrer"
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      advertising partners, and in some cases through the use of
                      cookies or other similar technologies (which you may
                  ...
                  <p>
                    We <i>[DO/DO NOT]</i> engage in fully automated
                    decision-making that has a legal or otherwise significant
                  ...
                  <ul>
                    <li>
                      ...
                      repeated failed transactions. This denylist persists for a
                    ...
                    <table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            Used in connection with navigation through a
                            storefront.
                          </td>
                        </tr>
                        <tr>
                    ...
                    <table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            Shopify analytics relating to marketing &amp;
                            referrals.
                          </td>
                        </tr>
                        <tr>
                  ...
                  <p>
                    ...
                    please contact us by e-mail at hello@okbutfirst.com&nbsp;or
                    by mail using the details provided below:
                  </p>
                  <p>1056 US HWY 9 South, Parlin NJ 08859, United States</p>
                  <p>
                ...
                <div
                  className={navActive[4] ? "tab-panes active" : "tab-panes"}
                ></div>
              </div>
            </div>
          </div>
