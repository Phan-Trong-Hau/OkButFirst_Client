    ...
    >
      <div className="roast-box">
        ...
        <div className="custom-calc-radio">
          <label>
            <span>Select</span>
            <input type="radio" name="productName" value={product?.name} />
          </label>
        </div>
      </div>
    </div>
            ...
            <div className="sub-banner-row">
              <div className="sub-col">
                <div className="sub-banner">
                  <img src={CoffeeClubProduct} alt="Coffee-Club-Product" />
                </div>
              </div>
              <div className="sub-col">
                <div className="sub-content">
                  ...
                  <p className="sub-desc">
                    Join the club, get club member-only perks.
                  </p>
                  <ul className="featuring">
                    <li>Free Shipping</li>
                    <li>Save more, up to 10% off</li>
                    <li>Freshly-roasted whole beans</li>
                    <li>Each 12 oz. bag makes ~30 cups of coffee</li>
                    <li>Delivered on your schedule, straight to your door</li>
                  </ul>
                  <button className="theme-btn__white">Get Start</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="know-wrapper">
              <div className="title-wrapper">
                <h2 className="title">CALCULATE, BEFORE YOU CAFFEINATE</h2>
              </div>
          ...
          <div className="container">
            <form acceptCharset="UTF-8">
              ...
              <div className="calc-step-one">
                ...
                <div className="attribute-roast">{attributeRoastList}</div>
              </div>
              <div className="calc-step-two">
                <div className="title-wrapper">
                  <h2 className="title">2. CHOOSE YOUR BAG QUANTITY</h2>
                </div>
                <div className="bag-quantity">{bagQuantityList}</div>
              </div>
              <div className="calc-step-three">
                <div className="title-wrapper">
                  <h2 className="title">3. CHOOSE YOUR SHIPPING FREQUENCY</h2>
                </div>
                <div className="bag-quantity">{shippingFrequency}</div>
              </div>
