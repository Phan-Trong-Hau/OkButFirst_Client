...
const Footer = () => {
  ...
  const handleOnClick = (e) => {
    if (e.currentTarget.parentElement.children[1] === prevElement.current[1]) {
              ...
              <div className="site-footer__bottom">
                <div className="footer-row">
                  ...
                  <div className="footer-col">
                    <h5 className="footer-title" onClick={handleOnClick}>
                      OK, BUT FIRST...
                      <img src={iconPlus} alt="icon-plus" />
                    </h5>
                    <ul className={"footer-list"}>
                      <li className="footer-item">
                        <Link to="/collections/coffee-shop">Coffee Shop</Link>
                      </li>
                      <li className="footer-item">
                      ...
                      <li className="footer-item">
                        <Link to="/blogs/coffee-101">Coffee 101</Link>
                      </li>
                      <li className="footer-item">
                        <Link to="/collections/merch-shop">Merch</Link>
                      </li>
                    </ul>
                  </div>
                  <div className="footer-col">
                    ...
                    <ul className="footer-list">
                      ...
                      <li className="footer-item">
                        <Link to="/pages/policies">Policies</Link>
                      </li>
                    </ul>
                  </div>
                  <div className="footer-col">
              ...
              <div className="site-footer__bottom">
                <div className="item">
                  <div className="footer-copyright">
                    <p>
                      Copyright © {year} Ok but first coffee - All rights
                      reserved.
                    </p>
                  </div>
                </div>
                <div className="item">
                  <div className="payment-methods">
                    ...
                    <div className="payment-methods__item">
                      <img src={discover} alt="discover-banking" />
                    </div>
                    <div className="payment-methods__item">
